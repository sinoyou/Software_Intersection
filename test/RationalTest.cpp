...
namespace test
{
	...
	public:
		...
		TEST_METHOD(TestRationalHash) {
			auto a1 = new Rational(31, 17373321);
			auto a2 = new Rational(31*2, 17373321*2);
			auto a3 = new Rational(10, 1);
			auto a4 = new Rational(17373322, 1);
			auto a5 = new Rational(1, 32);
			Assert::AreEqual(a1->hash(), a2->hash());
			Assert::AreEqual(a4->hash(), a5->hash());
			Assert::AreNotEqual(a1->hash(), a3->hash());
		}
	};
}
